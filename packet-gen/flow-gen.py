...
if __name__ == "__main__":
      ...
      # src=00:3a:9c:07:4d:87, dst=00:3a:9c:03:b8:c7
      ethernet_packet = [0x00, 0x3a, 0x9c, 0x03, 0xb8, 0xc7, 0x00, 0x3a, 0x9c,
                         0x07, 0x4d, 0x87, 0x08, 0x00]
      ...
      # src=2.2.2.2, dst=2.2.2.1 (vg.no), checksum, etc.
      ...
      r = sendeth(pack(ethernet_packet),
                  pack(ipv4_header + icmp_ping), "Eth1-49")
